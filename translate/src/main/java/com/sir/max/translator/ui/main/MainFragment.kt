package com.sir.max.translator.ui.main
...
import com.sir.max.translator.R
import com.sir.max.translator.analyzer.TextAnalyzer
import com.sir.max.translator.util.Language
...
class MainFragment : Fragment() {
    ...
    private fun setBottomCopyrightText() {
        val copyrightText = getString(R.string.powered_by_maksim_syramalotau_copyright)
        copyrightTextView.text =
            makeBoldCopyrightTextStartingWith(copyrightText, 3)
    }

    private fun makeBoldCopyrightTextStartingWith(
        copyrightText: String,
        firstBoldWordNumber: Int,
        wordDelimiter: String = " "
    ): SpannableStringBuilder {
        val anchorWords = copyrightText.split(wordDelimiter)

        return SpannableStringBuilder.valueOf(
            copyrightText.substringBefore(anchorWords[firstBoldWordNumber - 1])
        ).bold {
            append(copyrightText.substringAfter(anchorWords[firstBoldWordNumber - 2] + wordDelimiter))
        }
    }
